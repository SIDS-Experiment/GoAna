...
#ifndef SIDSPROGOPTIONS_H
#define SIDSPROGOPTIONS_H

#include "SIDSLog.h"
#include <boost/program_options.hpp>
#include <boost/filesystem.hpp>
#include "SIDSProgOptionsHelper.h"
#include <string>
#include <vector>
#include <iostream>
#include <fstream>
...
/*
 * SIDSProgOptions abstract base class 
 ...
 * 
 * class MyOptions : public SIDSProgOptions
 * {
 *      public : 
 *      MyOptions() : SIDSProgOptions()
 *      {
...
class SIDSProgOptions
{
  ...
  protected:
    ...
    std::map<std::string,sids::severity_level> fSeverityMap;
