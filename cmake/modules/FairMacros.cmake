...
#  file(MAKE_DIRECTORY ${new_path}/data)
  ...
  if(CMAKE_SYSTEM MATCHES Darwin)
    ...
    IF(BREIT_FOUND)
    configure_file(${BREIT_CMAKEMOD_DIR}/scripts/set_env_macos.sh.in
    ...
    IF(BREIT_FOUND)
    configure_file(${BREIT_CMAKEMOD_DIR}/scripts/set_env.sh.in
                   ${new_path}/${shell_script_name}
                  )
    ELSE(BREIT_FOUND)
...
IF(BREIT_FOUND)
  ...
  Add_Custom_Command(TARGET svnheader 
		     ...
		     -DBINARY_DIR=${CMAKE_BINARY_DIR}	      
                     ...
                     -DBREIT=${BREIT_CMAKEMOD_DIR}
                     -P ${BREIT_CMAKEMOD_DIR}/modules/GenerateVersionInfo.cmake
                      )
ELSE(BREIT_FOUND)
  Add_Custom_Target(svnheader ALL)
...
IF(BREIT_FOUND)
  ...
  Set(FAIRLIBDIR ${BREIT_LIBRARY_DIR})
